function ItunesController() {
      ...
      if (song.kind == 'song') {
        ...
        <div class="card col-md-3 col-xs-12 songs-box">
            ...
            <div class="img-container" id="imgBox${[i]}" style="background-image: url(${song.albumArt});">
              <a onclick="app.controllers.itunesCtrl.playSong(${[i]})"><img class="play-img" src="pics/play.png"></a>
            </div>
  ...
  this.playSong = function(i) {
    ...
    document.getElementById('imgBox' +i).innerHTML = `<a onclick="app.controllers.itunesCtrl.pauseSong(${i})"><img class="play-img" src="pics/pause.png"></a>`
  }

  this.pauseSong = function(i) {
    document.getElementById('audio' +i).pause()
    document.getElementById('imgBox' +i).innerHTML = `<a onclick="app.controllers.itunesCtrl.playSong(${i})"><img class="play-img" src="pics/play.png"></a>`
  }
  ...
  document.addEventListener('play', function (e) {
    ...
    for (var i = 0; i < audios.length; i++) {
      if (audios[i] != e.target) {
        app.controllers.itunesCtrl.pauseSong([i])
      }
    }
  }, true);
}
